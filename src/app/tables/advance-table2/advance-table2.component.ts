...
@Component({
  selector: 'app-advance-table2',
  templateUrl: './advance-table2.component.html',
  styleUrls: ['./advance-table2.component.sass']
})
export class AdvanceTable2Component implements OnInit {
